...
public class EntityFactory extends ShippartFactory {
    ...
    private void loadObject(File xmlFile) throws IOException, JDOMException {
        ...
        for (Element element : materials) {
            ...
            int value = Integer.parseInt(element.getChildText(DOM_NODE_VALUE)), durability = Integer
                    .parseInt(element.getChildText(DOM_NODE_VALUE)), weight = Integer
                    .parseInt(element.getChildText(DOM_NODE_WEIGHT));

            this.entities.add(createInstance(type, imagePath, name, durability,
                    value, weight));
    ...
    /**
     * Creating an instance of a material. Do not use this when you have the
     * image already loaded.
     * 
     * @throws IOException
     *             when the image can not be loaded
     */
    private Entity createInstance(String type, String imagePath, String name,
            int durability, int value, int weight) throws IOException {
    ...
    /**
     * Creating an instance of a material. Does not parse the image again. If
     * the image has been loaded this should be used.
     */
    private Entity createInstance(String type, BufferedImage image,
            String name, int durability, int value, int weight) {
    ...
    private Entity createInstance(String type, String name, int durability,
    ...
    public ShipPart instanzise(ShipPart prototype) {
        ...
        return createInstance(type, entityPrototype.getImage(),
